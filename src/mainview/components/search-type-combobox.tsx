...
export const SearchTypeCombobox = forwardRef<SearchTypeComboboxHandle>(
	function SearchTypeCombobox(_props, ref) {
			...
			<Popover open={open} onOpenChange={setOpen}>
				...
				<PopoverContent align="start" className="w-[280px] p-1">
					<div className="flex flex-col">
						...
						{NATIVE_TYPES.map((t) => {
							const active =
								activeSubType.kind === "native" &&
								activeSubType.type === t.type;
							return (
								<button
									key={t.type}
									type="button"
						...
						<button
							...
							onClick={() => {
								setOpen(false);
								// TODO task 18: passar "github" como section
								openDialog();
							}}
						>
